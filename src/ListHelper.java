...
public class ListHelper {
    ...
    public List<String[]> listToListOfArrays(List<String> list) {
	List<String[]>matrix=new ArrayList<String[]>();
	for (int i = 0; i <list.size(); i++) {
	    matrix.add(list.get(i).split(","));
	}
	return matrix;
    }
	...
	for (int i = 0; i < row; i++) {
		...
		try{
		    ...
		    System.out.println("which row: "+(i+1)+" fail: "+list.get(i).length);
		    System.out.println("fail at:"+list.get(i).toString());
		}
     ...
     */
    public List<String> rotateList(List<String> listToRotate, int rotateFrom) {
    ...
    public List<List<String>> discretize(List<String> toDiscretizeIn, int binAmount) {
	List<List<String>> discretized = new ArrayList<List<String>>();
